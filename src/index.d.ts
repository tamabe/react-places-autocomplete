...
export enum StatusEnum {
    ...
    OK = <any> 'OK',
    OVERQUERYLIMIT = <any> 'OVER_QUERY_LIMIT',
    REQUESTDENIED = <any> 'REQUEST_DENIED',
    UNKNOWNERROR = <any> 'UNKNOWN_ERROR',
    ZERORESULTS = <any> 'ZERO_RESULTS'
}
...
export interface PropTypes {
    ...
    fetchPredictions?: (value: string, searchOptions: SearchOptions,
        callback: (
